            ...
            <section className="bg-transparent dark:bg-gray-900">
                <div className="grid max-w-screen-xl px-4 py-8 mx-auto lg:gap-8 xl:gap-0 lg:py-16 lg:grid-cols-12">
                    <div className="mr-auto place-self-center lg:col-span-7">
                        ...
                        <a href="#" className="inline-flex items-center justify-center px-5 py-3 mr-3 text-base font-medium text-center text-white rounded-lg bg-primary-700 hover:bg-primary-800 dark:bg-blue-600 dark:hover:bg-blue-800 focus:ring-4 focus:ring-primary-300 dark:focus:ring-blue-900">
            ...
            <section className="bg-zinc-200 dark:bg-gray-900">
                <div className="grid max-w-screen-xl px-4 py-8 mx-auto lg:gap-8 xl:gap-0 lg:py-16 lg:grid-cols-12">
                    <div className="mr-auto place-self-center lg:col-span-7">
                        ...
                        <a
                            href="#"
                            aria-label="Explora propiedades en alquiler"
                        ...
                        <a
                            href="#"
                            aria-label="Habla con nuestro equipo de ventas"
                    ...
                    <div className="hidden lg:mt-0 lg:col-span-5 lg:flex">
                        <Image
                            src="https://example.com/path-to-your-property-image.jpg"
                            alt="Imagen de propiedades en renta"
                            width={500}
                            height={500}
                            layout="intrinsic"
                        />
