...
const Nav = () => {
    ...
    return (
        <>
            <Navbar onMenuOpenChange={setIsMenuOpen} className="font-normal bg-white border-b border-gray-200 dark:bg-gray-800 dark:border-gray-800">
                <NavbarContent>
                    <NavbarMenuToggle
                ...
                <NavbarContent className="hidden sm:flex gap-4" justify="center">
                    ...
                    <NavbarItem isActive>
                        <Link href="/propiedades" aria-current="page">
                            Customers
                        </Link>
                    </NavbarItem>
                </NavbarContent>
