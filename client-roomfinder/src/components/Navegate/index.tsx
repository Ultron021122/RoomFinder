        ...
        <aside className="h-screen">
            <nav className="h-full flex-col max-w-max bg-white dark:bg-gray-950 border-r dark:border-gray-900 shadow-sm">
                <div className="p-4 pb-2 flex justify-between items-center text-gray-800 dark:text-gray-100">
                    <div className={`overflow-hidden transition-all flex items-center ${expanded ? 'h-10' : 'w-0'}`}>
...
-2 23 -11 25 -27z"/>
                    ...
                    <button onClick={() => setExpanded(curr => !curr)} className="p-1.5 rounded-lg bg-gray-50 dark:bg-gray-950 hover:bg-gray-100 dark:hover:bg-gray-800">
                ...
                <div className="border-t border-gray-300 dark:border-gray-800 flex p-3">
                    ...
                    >
                        <div className="leading-4">
                            <h4 className="font-semibold dark:text-gray-300">Sebastián Martínez</h4>
                            <span className="text-xs text-gray-600 dark:text-gray-400">sebastian@gmail.com</span>
                        </div>
                        <MoreVertical size={20} className="text-gray-800 dark:text-gray-100" />
                    </div>
                </div>
            </nav>
        </aside>
