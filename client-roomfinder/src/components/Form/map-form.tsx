  ...
  return (
    <div className="space-y-4">
      <div className="w-full mb-5">
        ...
        <div className="flex">
          <span className="inline-flex items-center px-3 text-sm text-gray-900 bg-gray-200 border border-e-0 border-gray-300 rounded-s-md dark:bg-gray-500 dark:text-gray-500 dark:border-gray-600">
            <MapPin className="w-6 h-6 ml-1 text-gray-600 dark:text-gray-300" />
          </span>
          <input
            type="text"
            name="address"
