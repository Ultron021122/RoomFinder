...
const AppFloatingBox: React.FC<FloatingBoxProps> = ({ onClose, onUniversityChange }) => {
    ...
    return (
        <div className="absolute top-8 left-4 bg-white dark:bg-gray-950 w-72 lg:w-96 rounded-lg shadow-lg shadow-gray-400 dark:shadow-gray-500 p-4" style={{ zIndex: '1000' }}>
