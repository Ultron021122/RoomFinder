...
const roleAccessMap: Record<"admin" | "student" | "lessor", string[]> = {
  ...
  "student": ["/dashboard/profile", "/dashboard/home", "/dashboard/messages", "/dashboard/settings", "/dashboard/profile", "/dashboard/rentals", "/dashboard/request", "/dashboard/payments", "/dashboard/leases", "/dashboard/test", "/dashboard/inmuebles", "/dashboard/order-payments"],
